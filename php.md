...
##Exercises
<br> 1 . Modify the [PHP CRUD Tutorial](https://www.startutorial.com/articles/view/php-crud-tutorial-part-1) to turn it into a website that records customer bets. Record the bet description, odds and amount (demonstration will be provided).

...
<br> 1 . Add another 2 Invoice items to the invoice.xml file in the XMLExamples project in Eclipse. Change thea date to a UK format. Make sure that the XML file still validates against the invoice.dtd file. 
